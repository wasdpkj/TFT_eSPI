...
#define TFT_CS   PB14    // Do not define, read pin permanently connected to GND
#define TFT_DC   PB04    // Data Command control pin
#define TFT_RST  PB03    // Reset pin
